...
pub use platform::{
    ...
    CredentialStatus, DiscoverySettings, InitPhase, InitStatus, PlatformCatalog, PlatformStatus,
    ProviderDraft, RegisterInitialWorkspaceRequest, RegisterWorkspaceRequest, RegistrationRootId,
