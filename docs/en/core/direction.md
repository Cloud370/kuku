...
kuku writes everything an agent does into a single file on your disk.
...
|------------------------|-------------------|
| A CLI you install and chat with | kuku is a library. CLI is an app someone builds on it. |
